...
const POST_RESET_V2_PDT_CBEO_PUBLISH_R01_ROUTE =
  "/api/internal/etsy/post-reset-v2/pdt-cbeo-004/publish-r01";
const POST_RESET_V2_PDT_FWCT_MARKET_RESEARCH_R01_ROUTE =
