export const PDT_HBOP_001_V2_ALT_TEXT_R01 = {
  taskId: "PDT-HBOP-001-V2-ETSY-ALT-TEXT-R01-20260925 LISTING-4581821318 EXACT SCOPE ONLY",
  shopId: 23582741,
  listingId: 4581821318,
  ...
  buyerFiles: [
    "PDT-HBOP-001_V2_Cake_Order_Workflow_CLEAN.xlsx",
    "PDT-HBOP-001_V2_Cake_Order_Workflow_DEMO.xlsx",
    "PDT-HBOP-001_V2_Cake_Order_Form_Printable.pdf",
    "PDT-HBOP-001_V2_Quick_Start_Guide.pdf"
  ],
  expectedVideo: { count: 1, width: 1080, height: 1920 }
} as const;
