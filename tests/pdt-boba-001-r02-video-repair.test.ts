...
test("R02 reconciliation route is GET-only and delegates to read-only protected-state verification", async()=>{
  ...
  assert.match(source,/verifyPdtBoba001R02VideoProtectedState\(\)/);
