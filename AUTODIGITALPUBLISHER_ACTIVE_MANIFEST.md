...
- Shop Stats capture is evidence-only: no persistence, listing write, Product Truth change, or automatic patch is performed.
...
- Local Etsy Shop Stats evidence capture/export page
